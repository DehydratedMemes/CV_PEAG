...
\input{CV-Formacion_academica.tex}
	
%%%%%%%%%%%%%%%%%%%%%%%%%
%% RESEARCH EXPERIENCE %%
%%%%%%%%%%%%%%%%%%%%%%%%%

\input{CV-Experiencia_en_investigación}
...
%\input{CV-Diplomas.tex}
\input{CV-Cursos.tex}
\input{CV-Certifiaciones.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Actividad profesional
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{CV-Experiencia_laboral.tex}
	% Manual page break.
