...
\BulletItem
	...
	\begin{Detail}
		...
		{Predicción \textit{in-silico} de los mecanismos de la glicólisis de polietilentereftalato con sales de zinc como catalizadores: un estudio en DFT ωB97X-D4/def2-TZVP} \textattachfile{attachments/Reconocimiento de tesis.pdf}{Mostrar}
		\SubSubBulletItem
		Asesor:
    ...
    \Gap
		...
		\SubBulletItem
		\textbf{Examen de egreso (CENEVAL):} \textattachfile{attachments/EGEL.pdf}{Mostrar} \\
